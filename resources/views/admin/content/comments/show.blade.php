...
@section('head-tag')
<title>{{__('admin.show comment')}}</title>
@endsection
...
<nav aria-label="breadcrumb">
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item font-size-12 active" aria-current="page">{{__('admin.show comment')}}</li>
    </ol>
</nav>
    ...
    <section class="col-12">
        <section class="main-body-container">
            <section class="main-body-container-header">
                <h5>
                {{__('admin.show comment')}}
                </h5>
            </section>

            <section class="d-flex justify-content-between align-items-center mt-4 mb-3 border-bottom pb-2">
                <a href="{{ route('admin.content.comments.index') }}" class="btn btn-info btn-sm">{{__('admin.return')}}</a>
            </section>
            ...
            <section>
                <form action="{{ route('admin.content.comments.answer', $comment->id) }}" method="post">
                    @csrf
                    <section class="row">
                        <section class="col-12">
