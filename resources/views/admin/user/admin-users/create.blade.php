...
@section('head-tag')
<title>{{__('admin.create admin users')}}</title>
@endsection
...
<nav aria-label="breadcrumb">
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item font-size-12 active" aria-current="page">{{__('admin.create admin users')}}</li>
    </ol>
</nav>
...
<section class="row">
    <section class="col-12">
        <section class="main-body-container">
            ...
            <section>
                <form action="{{ route('admin.user.admin-users.store') }}" method="post" enctype="multipart/form-data">
                    @csrf
                    <section class="row">
