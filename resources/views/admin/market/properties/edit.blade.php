...
<nav aria-label="breadcrumb">
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item font-size-12 active" aria-current="page">{{__('admin.edit product form')}}</li>
    </ol>
</nav>
...
<section class="row">
    <section class="col-12">
        <section class="main-body-container">
            ...
            <section>
                <form action="{{ route('admin.market.properties.update', $categoryAttribute->id) }}" method="POST">
                    @csrf
                    @method('PUT')
                    <section class="row">
                        ...
                        <section class="col-12">
                            <div class="form-group">
                                ...
                                <select name="category_id" id="" class="form-control form-control-sm">
                                    ...
                                    <option value="{{ $productCategory->id }}" @if(old('category_id',
                                        $categoryAttribute->category_id) == $productCategory->id) selected
