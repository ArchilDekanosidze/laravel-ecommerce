...
@section('head-tag')
<title>{{__('admin.edit amazing sale')}}</title>
...
<nav aria-label="breadcrumb">
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item font-size-12 active" aria-current="page">{{__('admin.edit amazing sale')}}</li>
    </ol>
</nav>
...
<section class="row">
    <section class="col-12">
        <section class="main-body-container">
            ...
            <section>
                <form action="{{ route('admin.market.discounts.amazingSale.update', $amazingSale->id) }}" method="POST">
                    @csrf
                    @method("PUT")
                    <section class="row">
                        ...
                        <section class="col-12 col-md-6">
                            <div class="form-group">
                                ...
                                <select name="product_id" id="" class="form-control form-control-sm">
                                    ...
                                    <option value="{{ $product->id }}" @if(old('product_id', $amazingSale->product_id)
                        ...
                        <section class="col-12">
                            <div class="form-group">
                                ...
                                <select name="status" id="" class="form-control form-control-sm" id="status">
                                    <option value="0" @if (old('status', $amazingSale->status) == 0) selected
                                        @endif>{{__('admin.deactive')}}</option>
                                    <option value="1" @if (old('status', $amazingSale->status) == 1) selected
