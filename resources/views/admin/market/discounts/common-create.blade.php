...
@section('head-tag')
<title>{{__('admin.create common discount')}}</title>
...
<nav aria-label="breadcrumb">
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item font-size-12 active" aria-current="page">{{__('admin.create common discount')}}</li>
    </ol>
</nav>
    ...
    <section class="col-12">
        <section class="main-body-container">
            <section class="main-body-container-header">
                <h5>
                {{__('admin.create common discount')}}
                </h5>
            </section>
            ...
            <section>
                <form action="{{ route('admin.market.discounts.commonDiscount.store') }}" method="POST">
                    @csrf
                    ...
                    <section class="row">
                        ...
                        <section class="col-12 col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="minimal_order_amount" value="{{ old('minimal_order_amount') }}"
                                    class="form-control form-control-sm">
                            </div>
