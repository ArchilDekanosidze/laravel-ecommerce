                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <label>
                                    <input id="{{ $comment->id }}" onchange="changeStatus({{ $comment->id }})"
                                        data-url="{{ route('admin.market.comments.status', $comment->id) }}"
                            ...
                            <td class="width-16-rem text-left">
                                <a href="{{ route('admin.market.comments.show', $comment->id) }}"
                                    class="btn btn-info btn-sm"><i class="fa fa-eye"></i>{{__('admin.show')}}</a>

                                @if($comment->approved == 1)
                                <a href="{{ route('admin.market.comments.approved', $comment->id)}} "
                                    class="btn btn-warning btn-sm" type="submit"><i class="fa fa-clock"></i>{{__('admin.reject')}}</a>
                                @else
                                <a href="{{ route('admin.market.comments.approved', $comment->id)}}"
