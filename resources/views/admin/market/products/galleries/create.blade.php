...
@section('head-tag')
<title>{{__('admin.create image')}}</title>
...
<nav aria-label="breadcrumb">
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item font-size-12"> <a href="#">{{__('admin.gallery')}} </a></li>
        <li class="breadcrumb-item font-size-12 active" aria-current="page">{{__('admin.create image')}}</li>
    </ol>
</nav>
