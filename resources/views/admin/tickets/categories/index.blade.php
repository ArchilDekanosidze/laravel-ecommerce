    ...
    <section class="col-12">
        <section class="main-body-container">
            ...
            <section class="d-flex justify-content-between align-items-center mt-4 mb-3 border-bottom pb-2">
                <a href="{{ route('admin.ticket.categories.create') }}" class="btn btn-info btn-sm">{{__('admin.create category')}}</a>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <label>
                                    <input id="{{ $ticketCategory->id }}"
                                        ...
                                        data-url="{{ route('admin.ticket.categories.status', $ticketCategory->id) }}"
                            ...
                            <td class="width-16-rem text-left">
                                ...
                                <form class="d-inline"
                                    action="{{ route('admin.ticket.categories.destroy', $ticketCategory->id) }}"
                                    method="post">
                                    @csrf
                                    {{ method_field('delete') }}
