                    ...
                    <section class="content-header">
                        <section class="d-flex justify-content-between align-items-center">
                            <h2 class="content-header-title">
                                <span>{{__('public.most viewd')}}</span>
                            </h2>
                            <section class="content-header-link">
                                <a
                                    href="{{ route('customer.products', ['sort' => '4']) }}">{{__('public.view all')}}</a>
                            </section>
                        </section>
                    </section>
                    <!-- start vontent header -->
                            ...
                            <section class="item">
                                <section class="lazyload-item-wrapper">
                                    <section class="product">
                                        {{-- <section class="product-add-to-cart"><a href="#" data-bs-toggle="tooltip" data-bs-placement="left" title="Add to cart"><i class="fa fa-cart-plus"></i></a></section> --}}
                                        @guest
                                        <section class="product-add-to-favorite">
                                            <button class="btn btn-light btn-sm text-decoration-none"
                                                data-url="{{ route('customer.markets.add-to-favorite', $mostVisitedProduct) }}"
                                        ...
                                        <a class="product-link"
                                            href="{{ route('customer.markets.product', $mostVisitedProduct) }}">
            ...
            <section class="col">
                <section class="content-wrapper bg-white p-3 rounded-2">
                    ...
                    <section class="content-header">
                        <section class="d-flex justify-content-between align-items-center">
                            <h2 class="content-header-title">
                                <span>{{__('public.Amazon Suggestions')}}</span>
                            </h2>
                            <section class="content-header-link">
                                <a
                                    href="{{ route('customer.products', ['sort' => '5']) }}">{{__('public.view all')}}</a>
                            </section>
                        </section>
                    </section>
                    <!-- start vontent header -->
                            ...
                            <section class="item">
                                <section class="lazyload-item-wrapper">
                                    <section class="product">
                                        ...
                                        <section class="product-add-to-favorite">
                                            <button class="btn btn-light btn-sm text-decoration-none"
                                                data-url="{{ route('customer.markets.add-to-favorite', $offerProduct) }}"
                                                data-bs-toggle="tooltip" data-bs-placement="left"
                                                title="{{__('public.add to favorites')}}">
                                                <i class="fa fa-heart"></i>
                                            </button>
                                        ...
                                        @endauth
                                        <a class="product-link"
                                            href="{{ route('customer.markets.product', $offerProduct) }}">
                                            <section class="product-image">
                                                <img class=""
            ...
            <section class="col">
                ...
                <section class="content-header">
                    <section class="d-flex align-items-center">
                        <h2 class="content-header-title">
                            <span>{{__('public.special brands')}}</span>
                        </h2>
                    </section>
                </section>
                <!-- start vontent header -->
    ...
    <div class="toast" data-delay="7000" role="alert" aria-live="assertive" aria-atomic="true">
        ...
        <div class="toast-body">
            <strong class="ml-auto">
                {{__('public.you need to login in order to add to favorites')}}
                <br>
                <a href="{{ route('auth.login.form') }}" class="text-dark">
