<aside id="sidebar" class="sidebar col-md-3">
    ...
    <section class="content-wrapper bg-white p-3 rounded-2 mb-3">
        ...
        <section class="">
            <input class="sidebar-input-text" type="text" placeholder="{{__('public.search by brand name')}}..."
    ...
    <section class="content-wrapper bg-white p-3 rounded-2 mb-3">
        ...
        <section class="sidebar-price-range d-flex justify-content-between">
            <section class="p-1"><input type="text" placeholder="{{__('public.price from')}}..." name="min_price"
                    value="{{ request()->min_price }}"></section>
            <section class="p-1"><input type="text" placeholder="{{__('public.price to')}} ..." name="max_price"
    ...
    <section class="content-wrapper bg-white p-3 rounded-2 mb-3">
        <section class="sidebar-filter-btn d-grid gap-2">
            <button class="btn btn-danger" type="submit">{{__('public.apply filters')}}</button>
        </section>
    </section>

    </form>
    <div class="mb-3">
        <a href="{{ route('customer.products') }}" class="btn btn-warning">{{__('public.remove filters')}}</a>
    </div>
