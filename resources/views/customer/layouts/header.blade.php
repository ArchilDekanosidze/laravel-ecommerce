    ...
    <section class="top-header">
        <section class="container-xxl ">
            <section class="d-md-flex justify-content-md-between align-items-md-center py-3">
                    ...
                    <section class="search-box">
                        <section class="search-textbox">
                            ...
                            <form
                                ...
                                method="get" class='home-search-form'>
                ...
                <section class="mt-3 mt-md-auto text-end" style="z-index:99999999999">
                    <section class="d-inline px-md-3">
                        ...
                        <section class="dropdown-menu dropdown-menu-end custom-drop-down"
                            ...
                            <section><a class="dropdown-item" href="{{ route('customer.profiles.profile') }}"><i
                                        class="fa fa-user-circle"></i>{{__('public.profile')}}</a></section>
                            <section><a class="dropdown-item" href="{{ route('customer.profiles.orders') }}"><i
                                        class="fa fa-newspaper"></i>{{__('public.order')}}</a></section>
                            <section><a class="dropdown-item" href="{{ route('customer.profiles.my-favorites') }}"><i
                                        class="fa fa-heart"></i>{{__('public.my favorite')}}</a></section>
                            <section>
                                <hr class="dropdown-divider">
                            </section>
                            <section><a class="dropdown-item" href="{{route('auth.logout')}}"><i class="fa fa-sign-out-alt"></i>{{__('public.logout')}}</a>
                            </section>
                    ...
                    <section class="header-cart d-inline ps-3 border-start position-relative">
                        <a class="btn btn-link position-relative text-dark header-cart-link"
                            href="{{ route('customer.sales-process.carts.cart') }}">
                        ...
                        <section class="header-cart-dropdown">
                            <section class="border-bottom d-flex justify-content-between p-2">
                                <span class="text-muted">{{ $cartItems->count() }} {{__('public.items')}}</span>
                                <a class="text-decoration-none text-info"
                                    href="{{ route('customer.sales-process.carts.cart') }}">{{__('public.view cart')}}}</a>
                            </section>
                            <section class="header-cart-dropdown-body">
                                ...
                                <section
                                    ...
                                    <section class="w-100 text-truncate"><a class="text-decoration-none text-dark"
                                            href="{{ route('customer.markets.product', $cartItem->product) }}">{{
                            ...
                            <section
                                ...
                                <section class="">
                                    ...
                                    <section> {{ priceFormat($totalProductPrice - $totalDiscount) }}{{__('public.Dollar')}}</section>
                                </section>
                                <section class=""><a class="btn btn-danger btn-sm d-block" href="cart.html">{{__('public.create order')}}</a></section>
                            </section>
                        </section>
                    </section>
                    @endauth
        ...
        <section class="container-xxl ">
            <nav class="">
                <section class="d-none d-md-flex justify-content-md-start position-relative">
                    ...
                    <section class="navbar-item"><a href="#">{{__('public.market')}}</a></section>
                    <section class="navbar-item"><a href="#">{{__('public.discount and suggestion')}}</a></section>
                    <section class="navbar-item"><a href="#">{{__('public.My Amazon')}}</a></section>
                    <section class="navbar-item"><a href="#">{{__('public.Amazon plus')}}</a></section>
                    <section class="navbar-item"><a href="#">{{__('public.About us')}}</a></section>
                    <section class="navbar-item"><a href="#">{{__('public.Become a seller')}}</a></section>
                    <section class="navbar-item"><a href="#">{{__('public.job opportunities')}}</a></section>
                ...
                <section class="offcanvas offcanvas-start" tabindex="-1" id="offcanvasExample"
                    ...
                    <section class="navbar-item"><a href="#">{{__('public.job opportunities')}}</a></section>
                        ...
                        <section class="navbar-item"><a href="javascript:void(0)">{{__('public.Categories')}}</a></section>
                        <!-- start sidebar nav-->
