...
class CartController extends Controller
{
    ...
    public function updateCart(Request $request)
    {
        ...
        return redirect()->route('customer.sales-process.addresss.address-and-delivery');
    }
    ...
    public function addToCart(Product $product, Request $request)
    {
        if (Auth::check()) {
            ...
            return back()->with('alert-section-success', __('public.The product has been successfully added to the shopping cart'));
