...
class TicketController extends Controller
{
    ...
    public function answer(TicketRequest $request, Ticket $ticket)
    {
        ...
        return redirect()->route('admin.ticket.index')->with('swal-success', __('admin.Your answer has been successfully registered'));
    }
    ...
    public function change(Ticket $ticket)
    {
        ...
        $result = $ticket->save();
        return redirect()->route('admin.ticket.index')->with('swal-success', __('admin.Your change was successful'));
    }
}
